<?php class Plugin_Price_Rice_ThaiDao{
	...
	{
		return $this->orm->get_object_where("plugin_price_rice_thai","status='Open'","thaiID desc limit $limit");
	}
	public function selectAllByTypeLimit($thaiType,$limit)
	{
		return $this->orm->get_object_where("plugin_price_rice_thai","thaiType='$thaiType' and status='Open'","thaiID desc limit $limit");
	}
