<?php class Plugin_Price_Rice_Thai_PaddyDao{
	...
	{
		return $this->orm->get_object_where("plugin_price_rice_thai_paddy","thaiID='$thaiID' and departmentType='$departmentType'","paddyID desc");
	}
	public function selectAllByThaiIDAndName($thaiID,$paddyType)
	{
		return $this->orm->get_object_where("plugin_price_rice_thai_paddy","thaiID='$thaiID' and paddyType='$paddyType'","paddyID desc");
	}
