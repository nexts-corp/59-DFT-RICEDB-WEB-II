<?php class Plugin_Price_Rice_WorldDao{
	...
	public function selectAllByOpenLimit($limit,$dataType)
	{
		return $this->orm->get_object_where("plugin_price_rice_world","status='Open' and dataType='$dataType'","worldID desc limit $limit");
	}
