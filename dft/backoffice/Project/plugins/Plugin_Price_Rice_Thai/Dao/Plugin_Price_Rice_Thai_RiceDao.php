<?php class Plugin_Price_Rice_Thai_RiceDao{
	...
	public function selectAllByThaiIDAndName($thaiID,$riceType,$departmentType)
	{
		return $this->orm->get_object_where("plugin_price_rice_thai_rice","thaiID='$thaiID' and riceType='$riceType' and departmentType='$departmentType'","riceID desc");
	}
