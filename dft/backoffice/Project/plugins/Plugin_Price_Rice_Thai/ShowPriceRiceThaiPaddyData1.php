...
class  ShowPriceRiceThaiPaddyData1 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiPaddyData1()
	{
		...
		if($o_per[0]->permissView=="true")
			$this->Init("ShowPriceRiceThaiPaddyData1","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
			...
			ShowPriceRiceThaiPaddyData1::$Grid1=new TGridview();
			ShowPriceRiceThaiPaddyData1::$Grid1->setview("Grid1",$o);
			...
			$grid->additem(" ","");
			$grid->title=' ';
			ShowPriceRiceThaiPaddyData1::$Grid1->addcontrol($grid);
			...
			ShowPriceRiceThaiPaddyData1::$Grid1->View=false;
			ShowPriceRiceThaiPaddyData1::$Grid1->Edit=false;
			ShowPriceRiceThaiPaddyData1::$Grid1->Delete=$o_per[0]->permissDel;
			$this->Add(ShowPriceRiceThaiPaddyData1::$Grid1);
		...
		{
			$v=explode(",",$parameter);
			ShowPriceRiceThaiPaddyData1::$Grid1->gotopage($v[1]);
			ShowPriceRiceThaiPaddyData1::$Grid1->changenumpage($v[0]);
		 }
		...
		function frmNew($parameter,$sender)
		{
			...
			else
			{
				...
				Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData1&paddyID=$o->paddyID&thaiID=$o->thaiID","alert","save");
		...
		function Grid1_Editing($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData1::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData1::$Grid1->getstop();$i++)
			{
				$o=new plugin_price_rice_thai_paddy_data();
				

				$o->dataID=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("dataID",$i);
				$o->data1=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data1",$i);
				$o->data2=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data2",$i);
				$o->data3=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data3",$i);
				$o->data4=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data4",$i);
				$o->data5=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data5",$i);
				$o->data6=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data6",$i);
				$o->data7=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data7",$i);
				$o->data8=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("data8",$i);
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData1&paddyID=$paddyID&thaiID=$thaiID","alert","update");

		}
		function Grid1_Deleting($parameter,$sender)
		{
			$o=new plugin_price_rice_thai_paddy_data();
			$o->dataID=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("dataID",$parameter);
			$dao=new Plugin_Price_Rice_Thai_Paddy_DataDao();
			...
			$paddyID=$sender->getdata('paddyID');
			$thaiID=$sender->getdata('thaiID');
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData1&paddyID=$paddyID&thaiID=$thaiID","alert","del");
		}
		function frmDelAll($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData1::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData1::$Grid1->getstop();$i++)
			{
				...
				$o->cartoonpartIDCheck=ShowPriceRiceThaiPaddyData1::$Grid1->getvalues("cartoonpartIDCheck",$i);
		...
		function frmActionExcel($parameter,$sender)
		{
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData1&thaiID=$thaiID","alert","save");
		}
