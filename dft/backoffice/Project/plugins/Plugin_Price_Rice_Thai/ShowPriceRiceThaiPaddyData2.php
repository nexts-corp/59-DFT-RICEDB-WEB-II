...
class  ShowPriceRiceThaiPaddyData2 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiPaddyData2()
	{
		...
		if($o_per[0]->permissView=="true")
			$this->Init("ShowPriceRiceThaiPaddyData2","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
			...
			ShowPriceRiceThaiPaddyData2::$Grid1=new TGridview();
			ShowPriceRiceThaiPaddyData2::$Grid1->setview("Grid1",$o);
			...
			$grid->additem(" ","");
			$grid->title=' ';
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);
			
			$grid=new TTextBox();
			$grid->set('data1',"","","",true,"",false);
			$grid->title='ชนิดข้าว/เดือน';
			...
			$grid=new TTextBox();
			$grid->set('data3',"","","",true,"",false);
			$grid->title='ก.พ.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data4',"","","",true,"",false);
			$grid->title='มี.ค.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data5',"","","",true,"",false);
			$grid->title='เม.ย.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data6',"","","",true,"",false);
			$grid->title='พ.ค.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data7',"","","",true,"",false);
			$grid->title='มิ.ย.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data8',"","","",true,"",false);
			$grid->title='ก.ค.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data9',"","","",true,"",false);
			$grid->title='ส.ค.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data10',"","","",true,"",false);
			$grid->title='ก.ย.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data11',"","","",true,"",false);
			$grid->title='ต.ค.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data12',"","","",true,"",false);
			$grid->title='พ.ย.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data13',"","","",true,"",false);
			$grid->title='ธ.ค.';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data14',"","","",true,"",false);
			$grid->title='เฉลี่ย';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData2::$Grid1->addcontrol($grid);

			ShowPriceRiceThaiPaddyData2::$Grid1->View=false;
			ShowPriceRiceThaiPaddyData2::$Grid1->Edit=false;
			ShowPriceRiceThaiPaddyData2::$Grid1->Delete=$o_per[0]->permissDel;
			$this->Add(ShowPriceRiceThaiPaddyData2::$Grid1);
		...
		{
			$v=explode(",",$parameter);
			ShowPriceRiceThaiPaddyData2::$Grid1->gotopage($v[1]);
			ShowPriceRiceThaiPaddyData2::$Grid1->changenumpage($v[0]);
		 }
		...
		function frmNew($parameter,$sender)
		{
			...
			else
			{
				...
				Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData2&paddyID=$o->paddyID&thaiID=$o->thaiID","alert","save");
		...
		function Grid1_Editing($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData2::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData2::$Grid1->getstop();$i++)
			{
				$o=new plugin_price_rice_thai_paddy_data();
				

				$o->dataID=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("dataID",$i);
				$o->data1=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data1",$i);
				$o->data2=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data2",$i);
				$o->data3=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data3",$i);
				$o->data4=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data4",$i);
				$o->data5=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data5",$i);
				$o->data6=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data6",$i);
				$o->data7=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data7",$i);
				$o->data8=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data8",$i);
				$o->data9=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data9",$i);
				$o->data10=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data10",$i);
				$o->data11=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data11",$i);
				$o->data12=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data12",$i);
				$o->data13=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data13",$i);
				$o->data14=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("data14",$i);
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData2&paddyID=$paddyID&thaiID=$thaiID","alert","update");

		}
		function Grid1_Deleting($parameter,$sender)
		{
			$o=new plugin_price_rice_thai_paddy_data();
			$o->dataID=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("dataID",$parameter);
			$dao=new Plugin_Price_Rice_Thai_Paddy_DataDao();
			...
			$paddyID=$sender->getdata('paddyID');
			$thaiID=$sender->getdata('thaiID');
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData2&paddyID=$paddyID&thaiID=$thaiID","alert","del");
		}
		function frmDelAll($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData2::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData2::$Grid1->getstop();$i++)
			{
				...
				$o->cartoonpartIDCheck=ShowPriceRiceThaiPaddyData2::$Grid1->getvalues("cartoonpartIDCheck",$i);
		...
		function frmActionExcel($parameter,$sender)
		{
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData2&thaiID=$thaiID","alert","save");
		}
