...
class  ShowPriceRiceThaiPaddyData3 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiPaddyData3()
	{
		...
		if($o_per[0]->permissView=="true")
			$this->Init("ShowPriceRiceThaiPaddyData3","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
			...
			ShowPriceRiceThaiPaddyData3::$Grid1=new TGridview();
			ShowPriceRiceThaiPaddyData3::$Grid1->setview("Grid1",$o);
			...
			$grid->additem(" ","");
			$grid->title=' ';
			ShowPriceRiceThaiPaddyData3::$Grid1->addcontrol($grid);
			
			$grid=new TTextBox();
			$grid->set('data1',"","","",true,"",false);
			$grid->title='สัปดาห์ที่ 1';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData3::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data2',"","","",true,"",false);
			$grid->title='สัปดาห์ที่ 2';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData3::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data3',"","","",true,"",false);
			$grid->title='สัปดาห์ที่ 3';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData3::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data4',"","","",true,"",false);
			$grid->title='สัปดาห์ที่ 4';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData3::$Grid1->addcontrol($grid);

			$grid=new TTextBox();
			$grid->set('data5',"","","",true,"",false);
			$grid->title='สัปดาห์ที่ 5';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData3::$Grid1->addcontrol($grid);
			...
			ShowPriceRiceThaiPaddyData3::$Grid1->View=false;
			ShowPriceRiceThaiPaddyData3::$Grid1->Edit=false;
			ShowPriceRiceThaiPaddyData3::$Grid1->Delete=$o_per[0]->permissDel;
			$this->Add(ShowPriceRiceThaiPaddyData3::$Grid1);
		...
		{
			$v=explode(",",$parameter);
			ShowPriceRiceThaiPaddyData3::$Grid1->gotopage($v[1]);
			ShowPriceRiceThaiPaddyData3::$Grid1->changenumpage($v[0]);
		 }
		...
		function frmNew($parameter,$sender)
		{
			...
			else
			{
				...
				Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData3&paddyID=$o->paddyID&thaiID=$o->thaiID","alert","save");
		...
		function Grid1_Editing($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData3::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData3::$Grid1->getstop();$i++)
			{
				$o=new plugin_price_rice_thai_paddy_data();
				

				$o->dataID=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("dataID",$i);
				$o->data1=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("data1",$i);
				$o->data2=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("data2",$i);
				$o->data3=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("data3",$i);
				$o->data4=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("data4",$i);
				$o->data5=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("data5",$i);
				$o->data6=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("data6",$i);
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData3&paddyID=$paddyID&thaiID=$thaiID","alert","update");

		}
		function Grid1_Deleting($parameter,$sender)
		{
			$o=new plugin_price_rice_thai_paddy_data();
			$o->dataID=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("dataID",$parameter);
			$dao=new Plugin_Price_Rice_Thai_Paddy_DataDao();
			...
			$paddyID=$sender->getdata('paddyID');
			$thaiID=$sender->getdata('thaiID');
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData3&paddyID=$paddyID&thaiID=$thaiID","alert","del");
		}
		function frmDelAll($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData3::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData3::$Grid1->getstop();$i++)
			{
				...
				$o->cartoonpartIDCheck=ShowPriceRiceThaiPaddyData3::$Grid1->getvalues("cartoonpartIDCheck",$i);
		...
		function frmActionExcel($parameter,$sender)
		{
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData3&thaiID=$thaiID","alert","save");
		}
