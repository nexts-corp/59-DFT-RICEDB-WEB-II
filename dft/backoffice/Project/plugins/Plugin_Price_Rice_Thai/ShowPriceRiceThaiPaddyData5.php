...
class  ShowPriceRiceThaiPaddyData5 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiPaddyData5()
	{
		...
		if($o_per[0]->permissView=="true")
			$this->Init("ShowPriceRiceThaiPaddyData5","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
			...
			ShowPriceRiceThaiPaddyData5::$Grid1=new TGridview();
			ShowPriceRiceThaiPaddyData5::$Grid1->setview("Grid1",$o);
			...
			$grid->additem(" ","");
			$grid->title=' ';
			ShowPriceRiceThaiPaddyData5::$Grid1->addcontrol($grid);
			...
			ShowPriceRiceThaiPaddyData5::$Grid1->View=false;
			ShowPriceRiceThaiPaddyData5::$Grid1->Edit=false;
			ShowPriceRiceThaiPaddyData5::$Grid1->Delete=$o_per[0]->permissDel;
			$this->Add(ShowPriceRiceThaiPaddyData5::$Grid1);
		...
		{
			$v=explode(",",$parameter);
			ShowPriceRiceThaiPaddyData5::$Grid1->gotopage($v[1]);
			ShowPriceRiceThaiPaddyData5::$Grid1->changenumpage($v[0]);
		 }
		...
		function frmNew($parameter,$sender)
		{
			...
			else
			{
				...
				Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData5&paddyID=$o->paddyID&thaiID=$o->thaiID","alert","save");
		...
		function Grid1_Editing($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData5::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData5::$Grid1->getstop();$i++)
			{
				$o=new plugin_price_rice_thai_paddy_data();
				

				$o->dataID=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("dataID",$i);
				$o->data1=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data1",$i);
				$o->data2=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data2",$i);
				$o->data3=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data3",$i);
				$o->data4=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data4",$i);
				$o->data5=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data5",$i);
				$o->data6=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data6",$i);
				$o->data7=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data7",$i);
				$o->data8=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("data8",$i);
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData5&paddyID=$paddyID&thaiID=$thaiID","alert","update");

		}
		function Grid1_Deleting($parameter,$sender)
		{
			$o=new plugin_price_rice_thai_paddy_data();
			$o->dataID=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("dataID",$parameter);
			$dao=new Plugin_Price_Rice_Thai_Paddy_DataDao();
			...
			$paddyID=$sender->getdata('paddyID');
			$thaiID=$sender->getdata('thaiID');
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData5&paddyID=$paddyID&thaiID=$thaiID","alert","del");
		}
		function frmDelAll($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData5::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData5::$Grid1->getstop();$i++)
			{
				...
				$o->cartoonpartIDCheck=ShowPriceRiceThaiPaddyData5::$Grid1->getvalues("cartoonpartIDCheck",$i);
		...
		function frmActionExcel($parameter,$sender)
		{
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData5&thaiID=$thaiID","alert","save");
		}
