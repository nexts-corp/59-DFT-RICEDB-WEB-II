...
class  ShowPriceRiceThaiPaddyData6 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiPaddyData6()
	{
		...
		if($o_per[0]->permissView=="true")
			$this->Init("ShowPriceRiceThaiPaddyData6","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
			...
			ShowPriceRiceThaiPaddyData6::$Grid1=new TGridview();
			ShowPriceRiceThaiPaddyData6::$Grid1->setview("Grid1",$o);
			...
			$grid->additem(" ","");
			$grid->title=' ';
			ShowPriceRiceThaiPaddyData6::$Grid1->addcontrol($grid);
			...
			$grid->title='สัปดาห์ก่อน ต่ำ-สูง';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData6::$Grid1->addcontrol($grid);
			...
			$grid->title='สัปดาห์นี้ ต่ำ-สูง';
			$grid->setAttribute("class","form-control");
			ShowPriceRiceThaiPaddyData6::$Grid1->addcontrol($grid);


			ShowPriceRiceThaiPaddyData6::$Grid1->View=false;
			ShowPriceRiceThaiPaddyData6::$Grid1->Edit=false;
			ShowPriceRiceThaiPaddyData6::$Grid1->Delete=$o_per[0]->permissDel;
			$this->Add(ShowPriceRiceThaiPaddyData6::$Grid1);
		...
		{
			$v=explode(",",$parameter);
			ShowPriceRiceThaiPaddyData6::$Grid1->gotopage($v[1]);
			ShowPriceRiceThaiPaddyData6::$Grid1->changenumpage($v[0]);
		 }
		...
		function frmNew($parameter,$sender)
		{
			...
			else
			{
				...
				Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData6&paddyID=$o->paddyID&thaiID=$o->thaiID","alert","save");
		...
		function Grid1_Editing($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData6::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData6::$Grid1->getstop();$i++)
			{
				$o=new plugin_price_rice_thai_paddy_data();
				

				$o->dataID=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("dataID",$i);
				$o->data1=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data1",$i);
				$o->data2=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data2",$i);
				$o->data3=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data3",$i);
				$o->data4=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data4",$i);
				$o->data5=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data5",$i);
				$o->data6=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data6",$i);
				$o->data7=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data7",$i);
				$o->data8=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("data8",$i);
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData6&paddyID=$paddyID&thaiID=$thaiID","alert","update");

		}
		function Grid1_Deleting($parameter,$sender)
		{
			$o=new plugin_price_rice_thai_paddy_data();
			$o->dataID=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("dataID",$parameter);
			$dao=new Plugin_Price_Rice_Thai_Paddy_DataDao();
			...
			$paddyID=$sender->getdata('paddyID');
			$thaiID=$sender->getdata('thaiID');
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData6&paddyID=$paddyID&thaiID=$thaiID","alert","del");
		}
		function frmDelAll($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData6::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData6::$Grid1->getstop();$i++)
			{
				...
				$o->cartoonpartIDCheck=ShowPriceRiceThaiPaddyData6::$Grid1->getvalues("cartoonpartIDCheck",$i);
		...
		function frmActionExcel($parameter,$sender)
		{
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData6&thaiID=$thaiID","alert","save");
		}
