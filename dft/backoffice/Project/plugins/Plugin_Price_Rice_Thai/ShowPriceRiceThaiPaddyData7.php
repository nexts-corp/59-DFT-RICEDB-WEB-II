...
class  ShowPriceRiceThaiPaddyData7 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiPaddyData7()
	{
		...
		if($o_per[0]->permissView=="true")
			$this->Init("ShowPriceRiceThaiPaddyData7","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
			...
			ShowPriceRiceThaiPaddyData7::$Grid1=new TGridview();
			ShowPriceRiceThaiPaddyData7::$Grid1->setview("Grid1",$o);
			...
			$grid->additem(" ","");
			$grid->title=' ';
			ShowPriceRiceThaiPaddyData7::$Grid1->addcontrol($grid);
			...
			ShowPriceRiceThaiPaddyData7::$Grid1->View=false;
			ShowPriceRiceThaiPaddyData7::$Grid1->Edit=false;
			ShowPriceRiceThaiPaddyData7::$Grid1->Delete=$o_per[0]->permissDel;
			$this->Add(ShowPriceRiceThaiPaddyData7::$Grid1);
		...
		{
			$v=explode(",",$parameter);
			ShowPriceRiceThaiPaddyData7::$Grid1->gotopage($v[1]);
			ShowPriceRiceThaiPaddyData7::$Grid1->changenumpage($v[0]);
		 }
		...
		function frmNew($parameter,$sender)
		{
			...
			else
			{
				...
				Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData7&paddyID=$o->paddyID&thaiID=$o->thaiID","alert","save");
		...
		function Grid1_Editing($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData7::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData7::$Grid1->getstop();$i++)
			{
				$o=new plugin_price_rice_thai_paddy_data();
				

				$o->dataID=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("dataID",$i);
				$o->data1=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data1",$i);
				$o->data2=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data2",$i);
				$o->data3=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data3",$i);
				$o->data4=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data4",$i);
				$o->data5=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data5",$i);
				$o->data6=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data6",$i);
				$o->data7=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data7",$i);
				$o->data8=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data8",$i);
				$o->data9=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data9",$i);
				$o->data10=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data10",$i);
				$o->data11=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data11",$i);
				$o->data12=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data12",$i);
				$o->data13=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data13",$i);
				$o->data14=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("data14",$i);
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData7&paddyID=$paddyID&thaiID=$thaiID","alert","update");

		}
		function Grid1_Deleting($parameter,$sender)
		{
			$o=new plugin_price_rice_thai_paddy_data();
			$o->dataID=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("dataID",$parameter);
			$dao=new Plugin_Price_Rice_Thai_Paddy_DataDao();
			...
			$paddyID=$sender->getdata('paddyID');
			$thaiID=$sender->getdata('thaiID');
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData7&paddyID=$paddyID&thaiID=$thaiID","alert","del");
		}
		function frmDelAll($parameter,$sender)
		{
			...
			for($i=ShowPriceRiceThaiPaddyData7::$Grid1->getstart();$i<ShowPriceRiceThaiPaddyData7::$Grid1->getstop();$i++)
			{
				...
				$o->cartoonpartIDCheck=ShowPriceRiceThaiPaddyData7::$Grid1->getvalues("cartoonpartIDCheck",$i);
		...
		function frmActionExcel($parameter,$sender)
		{
			...
			Refreshs("Plugin_Price_Rice_Thai/ShowPriceRiceThaiPaddyData7&thaiID=$thaiID","alert","save");
		}
