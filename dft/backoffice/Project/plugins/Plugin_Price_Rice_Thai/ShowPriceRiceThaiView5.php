...
class  ShowPriceRiceThaiView5 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiView5()
	{
		...
		if($o_per[0]->permissView=="true" or $_SESSION["Session_User_UsertypeID"]=="2")
			$this->Init("ShowPriceRiceThaiView5","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
