...
class  ShowPriceRiceThaiView6 extends TForm
{
	public static $Grid1;
	function ShowPriceRiceThaiView6()
	{
		...
		if($o_per[0]->permissView=="true" or $_SESSION["Session_User_UsertypeID"]=="2")
			$this->Init("ShowPriceRiceThaiView6","Plugin_Price_Rice_Thai","form-horizontal row-border",true);
