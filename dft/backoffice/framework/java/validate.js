...
/*function __doPostBack_Signup(eventTarget, eventArgument) { 
	if (validateForms('Signup')){   
	 document.all.Signup.__EVENTTARGET_Signup.value = eventTarget;
	 document.all.Signup.__EVENTARGUMENT_Signup.value = eventArgument;
	 document.all.Signup.submit();
	}
}*/
