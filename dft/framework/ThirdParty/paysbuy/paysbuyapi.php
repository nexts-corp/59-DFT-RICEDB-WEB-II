...
if($num_exist<1)
{
	...
	if($invoice != "" and $p_name != "")
	{
		...
		$s_insert_order = "insert into order_detail (detail_id, ordernumber, product_id, product_name, order_email, order_time, order_unit, product_price, price_free, pay_method, order_status) ";
		$s_insert_order .= "values ('', '$invoice', '$p_id', '$p_name', '$_COOKIE[mem_email]', NOW(), '$unit' ,'$order_price', '$p_free', '$pay_method', '$order_status')";
						...
						*/
						...
						else
						{
							...
							else 
							{
								...
								//Change to your URL
								$resp_front_url = "http://www.alldealsthailand.com/payment-thank.php";
								$resp_back_url = "http://www.alldealsthailand.com/index.php";
								//$resp_back_url = "";
