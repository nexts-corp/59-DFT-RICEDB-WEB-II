...
function CheckAuthentication()
{
	...
	if($_SESSION["Session_User_UserID"])
	{
				...
				$check_dir=file_exists ("./Upload/".$_SESSION["Session_User_Upload"]."");
				if(empty($check_dir))
						mkdir("./Upload/".$_SESSION["Session_User_Upload"]."",0755,true);
...
*/
		echo $_SESSION["Session_User_Upload"];
		$baseUrl = dirname($_SERVER['PHP_SELF'])."/Upload/".$_SESSION["Session_User_Upload"]."/";
