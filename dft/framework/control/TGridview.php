...
class TGridview extends TControl
{
	...
	function getDelete($rowindex)
	{
			...
			if($this->Delete=="true")
		{
			...
			$html=$html."<a class='btn btn-danger btn-xs delete' href='#' $ev><i class='fa fa-trash-o'></i>Delete</a>";
			//$html=$html. "</td>";
		}
		return $html;
	}
	...
	function getEdit($rowindex)
	{
		...
		if($this->Edit=="true")
		{
			...
			$html=$html."<a class='btn btn-info btn-xs edit' href='#' $ev><i class='fa fa-edit'></i>Edit</a>";
			//$html=$html. "</td>";
		}
		return $html;
	}
